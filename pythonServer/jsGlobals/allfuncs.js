  ...
  function newfunc(func, testfunc) {
    ...
    var retfunc = function () {
      ...
      return testfunc({
         ...
         * @param {string|Array|undefined} match - if set the type to check against or array of ytpes to check against
    ...
    function createelem(parent, elem, data = {}) {
      ...
      if (data.class) {
        if (Array.isArray(data.class)) {
          data.class.forEach((e) => elem.classList.add(e))
        } else if (typeof data.class === "string") {
          data.class.split(" ").forEach((e) => elem.classList.add(e))
        }
      }
